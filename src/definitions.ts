...
export interface AzurePushNotificationsPlugin {
  /**
  ...
  addListener(
    ...
    listenerFunc: (notification: AzurePushNotificationSchema) => void,
  ): Promise<PluginListenerHandle> & PluginListenerHandle;
...
export interface AzurePushNotificationSchema {
  /**
...
export interface DeliveredNotifications {
   ...
   * @since 1.0.0
   */
  notifications: AzurePushNotificationSchema[];
}
 ...
 * @since 1.0.0
 */
export type PushNotification = AzurePushNotificationSchema;
